...
(async () => {
  ...
  await fs.writeFile("hidradenitis-suppurativa-potential-cases.csv", "patient-id,dob,codes,last-encounter\n");
  for(let patient in patients) {
    try {
      ...
      await fs.appendFile("hidradenitis-suppurativa-potential-cases.csv", row);
    } catch(error) {
      console.log(error);
    }
  }
